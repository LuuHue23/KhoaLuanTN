      ...
      <div class="card">
        <div class="card-body">
          <div class="d-flex align-items-center justify-content-md-center">
            ...
            <div class="ml-3">
              <p class="mb-0">Số lượng nhân viên</p>
              <h6>{{$staff}}</h6>
            </div>
          </div>
        </div>
      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="d-flex table-responsive">
           ...
           <!--    <button class="btn btn-sm btn-light"><i class="mdi mdi-plus-circle-outline"></i> Add</button> -->
             <button type="button" class="btn btn-light"><i class="icon icon-star"></i></button>
