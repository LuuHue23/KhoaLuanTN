  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
        <a class="navbar-brand brand-logo" href="{{route('indexx')}}"><img src="{{url('public/Admin')}}/images/logo.svg" alt="logo"/></a>
  ...
  <div id="right-sidebar" class="settings-panel">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{route('indexx')}}">
           ...
           <!--  <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{route('list_kpii')}}">
                <i class="icon-clock menu-icon"></i>
                <span class="menu-title">Mục tiêu của tôi</span>
              </a>
            </li>
          ...
          <li class="nav-item">
             ...
             <li class="nav-item">
              <a class="nav-link" href="{{route('view_rate')}}">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="auth">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="pages/samples/lock-screen.html"> Khóa tài khoản </a></li>
                </ul>
              </div>
            </li> -->
